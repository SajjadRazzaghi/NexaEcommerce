...
using NexaECommerce.Server.Platform.Health;
...
using NexaECommerce.Server.Platform.Versioning;

namespace NexaECommerce.Server.Platform;
...
public static class DependencyInjection
{
    public static IServiceCollection AddPlatform(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddDataProtection()
            ...
            .SetApplicationName("NexaECommerce");
        ...
        services.TryAddSingleton<NexaECommerce.Server.Platform.Webhooks.IEventBus, NexaECommerce.Server.Platform.Webhooks.NoopEventBus>();
