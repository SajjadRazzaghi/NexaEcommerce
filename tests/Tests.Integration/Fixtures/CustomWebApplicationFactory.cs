...
public sealed class CustomWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    private readonly string _dbPath = Path.Combine(Path.GetTempPath(), $"nexaecommerce-test-{Guid.NewGuid():N}.db");
    private readonly string _hangfirePath = Path.Combine(Path.GetTempPath(), $"nexaecommerce-test-hangfire-{Guid.NewGuid():N}.db");
