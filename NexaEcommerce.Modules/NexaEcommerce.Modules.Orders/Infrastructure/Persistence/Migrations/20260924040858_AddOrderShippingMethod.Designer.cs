...
namespace NexaEcommerce.Modules.Orders.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260924040858_AddOrderShippingMethod")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexaEcommerce.Modules.Orders.Domain.Entities.Coupon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NexaEcommerce.Modules.Orders.Domain.Entities.CouponRedemption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CouponRedemptions", "Orders");
                });

            modelBuilder.Entity("NexaEcommerce.Modules.Orders.Domain.Entities.Fulfillment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NexaEcommerce.Modules.Orders.Domain.Entities.Package", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "OrderId", "PackageNumber")
                        .IsUnique();

                    b.ToTable("Packages", "Orders");
                });
            ...
            modelBuilder.Entity("NexaEcommerce.Modules.Orders.Domain.Entities.Shipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NexaEcommerce.Modules.Orders.Domain.Entities.ShippingMethod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NexaEcommerce.Modules.Orders.Domain.Entities.TaxRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NexaEcommerce.Modules.Orders.Domain.Entities.Package", b =>
                {
                    b.HasOne("NexaEcommerce.Modules.Orders.Domain.Entities.Fulfillment", null)
                        .WithMany()
